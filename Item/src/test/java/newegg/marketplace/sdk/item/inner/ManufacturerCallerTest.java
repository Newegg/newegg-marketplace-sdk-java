...
import newegg.marketplace.sdk.item.model.SubmitManufacturerRequest;
import newegg.marketplace.sdk.item.model.SubmitManufacturerRequest.RequestBody.ManufacturerRequest;
import newegg.marketplace.sdk.item.model.SubmitManufacturerResponse;
import newegg.marketplace.sdk.item.model.GetManufacturerRequestStatusRequest;
import newegg.marketplace.sdk.item.model.GetManufacturerRequestStatusRequest.RequestBody.ManufacturerList;
import newegg.marketplace.sdk.item.model.GetManufacturerRequestStatusResponse;
import newegg.marketplace.sdk.item.model.ManufacturerLookupRequest;
import newegg.marketplace.sdk.item.model.ManufacturerLookupRequest.RequestBody.RequestCriteria;
import newegg.marketplace.sdk.item.model.ManufacturerLookupForInternationalCountryRequest;
import newegg.marketplace.sdk.item.model.ManufacturerLookupResponse;
import newegg.marketplace.sdk.item.model.ManufacturerLookupForInternationalCountryResponse;
