...
public class ReportConfig extends APIConfig {
	private org.apache.logging.log4j.Logger log = LogManager.getLogger(ReportConfig.class);
	
	public ReportConfig() throws ConfigurationException {
		super();
		load();
	}
	...
	private void load() {
		...
		Variables.SimulationEnabled = config.getBoolean("newegg.report.simulation");
