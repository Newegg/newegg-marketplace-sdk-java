...
// 產生時間: 2019.03.06 於 01:57:23 PM CST 
//
...
public class SDailyInventBtoBCANResponse {
    ...
    protected SDailyInventBtoBCANResponse.ResponseBody responseBody;
     ...
     * @return
     *     possible object is
     *     {@link SDailyInventBtoBCANResponse.ResponseBody }
     *     
     */
    public SDailyInventBtoBCANResponse.ResponseBody getResponseBody() {
        return responseBody;
    }
     ...
     *     
     */
    public void setResponseBody(SDailyInventBtoBCANResponse.ResponseBody value) {
    ...
    public static class ResponseBody {
        ...
        protected SDailyInventBtoBCANResponse.ResponseBody.ResponseList responseList;
         ...
         * @return
         *     possible object is
         *     {@link SDailyInventBtoBCANResponse.ResponseBody.ResponseList }
         *     
         */
        public SDailyInventBtoBCANResponse.ResponseBody.ResponseList getResponseList() {
            return responseList;
        }
         ...
         *     
         */
        public void setResponseList(SDailyInventBtoBCANResponse.ResponseBody.ResponseList value) {
        ...
        public static class ResponseList {
            ...
            protected List<SDailyInventBtoBCANResponse.ResponseBody.ResponseList.ResponseInfo> responseInfo;
             ...
             * {@link SDailyInventBtoBCANResponse.ResponseBody.ResponseList.ResponseInfo }
             * 
             * @return
             * Objects of the following type(s) are allowed in the list
             * {@link SDailyInventBtoBCANResponse.ResponseBody.ResponseList.ResponseInfo }
             * 
             */
            public List<SDailyInventBtoBCANResponse.ResponseBody.ResponseList.ResponseInfo> getResponseInfo() {
                if (responseInfo == null) {
                    responseInfo = new ArrayList<SDailyInventBtoBCANResponse.ResponseBody.ResponseList.ResponseInfo>();
                }
