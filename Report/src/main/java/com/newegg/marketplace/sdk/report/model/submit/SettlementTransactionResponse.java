...
// 產生時間: 2019.03.06 於 10:14:29 AM CST 
//
...
public class SettlementTransactionResponse {
    ...
    @XmlElement(name = "OperationType", defaultValue = "SettlementTransactionReportResponse", required = true)
    @JsonProperty("OperationType")
    protected String operationType = "SettlementTransactionReportResponse";
    @XmlElement(name = "SellerID", required = true)
    @JsonProperty("SellerID")
    protected String sellerID;
    @XmlElement(name = "ResponseBody", required = true)
    @JsonProperty("ResponseBody")
    protected SettlementTransactionResponse.ResponseBody responseBody;
     ...
     * @return
     *     possible object is
     *     {@link SettlementTransactionResponse.ResponseBody }
     *     
     */
    public SettlementTransactionResponse.ResponseBody getResponseBody() {
        return responseBody;
    }
     ...
     *     
     */
    public void setResponseBody(SettlementTransactionResponse.ResponseBody value) {
    ...
    public static class ResponseBody {
        ...
        @JsonUnwrapped
        protected SettlementTransactionResponse.ResponseBody.ResponseList responseList;
         ...
         * @return
         *     possible object is
         *     {@link SettlementTransactionResponse.ResponseBody.ResponseList }
         *     
         */
        public SettlementTransactionResponse.ResponseBody.ResponseList getResponseList() {
            return responseList;
        }
         ...
         *     
         */
        public void setResponseList(SettlementTransactionResponse.ResponseBody.ResponseList value) {
        ...
        public static class ResponseList {
            ...
            protected List<SettlementTransactionResponse.ResponseBody.ResponseList.ResponseInfo> responseInfo;
             ...
             * {@link SettlementTransactionResponse.ResponseBody.ResponseList.ResponseInfo }
             * 
             * @return
             * Objects of the following type(s) are allowed in the list
             * {@link SettlementTransactionResponse.ResponseBody.ResponseList.ResponseInfo }
             * 
             */
            public List<SettlementTransactionResponse.ResponseBody.ResponseList.ResponseInfo> getResponseInfo() {
                if (responseInfo == null) {
                    responseInfo = new ArrayList<SettlementTransactionResponse.ResponseBody.ResponseList.ResponseInfo>();
                }
