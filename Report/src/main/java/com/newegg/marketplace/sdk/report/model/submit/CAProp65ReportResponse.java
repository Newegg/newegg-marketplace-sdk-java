...
// 產生時間: 2019.03.06 於 02:35:34 PM CST 
//
...
public class CAProp65ReportResponse {

    @XmlElement(name = "IsSuccess", required = true)
    @JsonProperty("IsSuccess")
    protected String isSuccess;
    @XmlElement(name = "OperationType", defaultValue = "CAProp65ReportResponse", required = true)
    @JsonProperty("OperationType")
    protected String operationType = "CAProp65ReportResponse";
    @XmlElement(name = "SellerID", required = true)
    @JsonProperty("SellerID")
    protected String sellerID;
    @XmlElement(name = "ResponseBody", required = true)
    @JsonProperty("ResponseBody")
    protected CAProp65ReportResponse.ResponseBody responseBody;
     ...
     * @return
     *     possible object is
     *     {@link CAProp65ReportResponse.ResponseBody }
     *     
     */
    public CAProp65ReportResponse.ResponseBody getResponseBody() {
        return responseBody;
    }
     ...
     *     
     */
    public void setResponseBody(CAProp65ReportResponse.ResponseBody value) {
    ...
    public static class ResponseBody {
        ...
        @JsonUnwrapped
        protected CAProp65ReportResponse.ResponseBody.ResponseList responseList;
         ...
         * @return
         *     possible object is
         *     {@link CAProp65ReportResponse.ResponseBody.ResponseList }
         *     
         */
        public CAProp65ReportResponse.ResponseBody.ResponseList getResponseList() {
            return responseList;
        }
         ...
         *     
         */
        public void setResponseList(CAProp65ReportResponse.ResponseBody.ResponseList value) {
        ...
        public static class ResponseList {
            ...
            protected List<CAProp65ReportResponse.ResponseBody.ResponseList.ResponseInfo> responseInfo;
             ...
             * {@link CAProp65ReportResponse.ResponseBody.ResponseList.ResponseInfo }
             * 
             * @return
             * Objects of the following type(s) are allowed in the list
             * {@link CAProp65ReportResponse.ResponseBody.ResponseList.ResponseInfo }
             * 
             */
            public List<CAProp65ReportResponse.ResponseBody.ResponseList.ResponseInfo> getResponseInfo() {
                if (responseInfo == null) {
                    responseInfo = new ArrayList<CAProp65ReportResponse.ResponseBody.ResponseList.ResponseInfo>();
                }
