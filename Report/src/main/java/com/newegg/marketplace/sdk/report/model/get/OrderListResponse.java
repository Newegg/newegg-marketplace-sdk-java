...
public class OrderListResponse {
    ...
    protected OrderListResponse.ResponseBody responseBody;
     ...
     *     
     */
    public OrderListResponse.ResponseBody getResponseBody() {
        return responseBody;
    }
     ...
     *     
     */
    public void setResponseBody(OrderListResponse.ResponseBody value) {
    ...
    public static class ResponseBody {
        ...
        protected OrderListResponse.ResponseBody.PageInfo pageInfo;
        ...
        @JsonUnwrapped
        protected OrderListResponse.ResponseBody.OrderInfoList orderInfoList;
         ...
         *     
         */
        public OrderListResponse.ResponseBody.PageInfo getPageInfo() {
            return pageInfo;
        }
         ...
         *     
         */
        public void setPageInfo(OrderListResponse.ResponseBody.PageInfo value) {
            this.pageInfo = value;
        }
         ...
         *     
         */
        public OrderListResponse.ResponseBody.OrderInfoList getOrderInfoList() {
         ...
         *     
         */
        public void setOrderInfoList(OrderListResponse.ResponseBody.OrderInfoList value) {
        ...
        public static class OrderInfoList {
            ...
            protected List<OrderListResponse.ResponseBody.OrderInfoList.OrderInfo> orderInfo;
             ...
             * 
             */
            public List<OrderListResponse.ResponseBody.OrderInfoList.OrderInfo> getOrderInfo() {
                if (orderInfo == null) {
                    orderInfo = new ArrayList<OrderListResponse.ResponseBody.OrderInfoList.OrderInfo>();
                }
            ...
            public static class OrderInfo {
                ...
                protected OrderListResponse.ResponseBody.OrderInfoList.OrderInfo.ItemInfoList itemInfoList;
                @XmlElement(name = "PackageInfoList", required = true)
                @JsonProperty("PackageInfoList")
                protected OrderListResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList packageInfoList;
                 ...
                 *     
                 */
                public OrderListResponse.ResponseBody.OrderInfoList.OrderInfo.ItemInfoList getItemInfoList() {
                    return itemInfoList;
                }
                 ...
                 *     
                 */
                public void setItemInfoList(OrderListResponse.ResponseBody.OrderInfoList.OrderInfo.ItemInfoList value) {
                 ...
                 *     
                 */
                public OrderListResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList getPackageInfoList() {
                 ...
                 *     
                 */
                public void setPackageInfoList(OrderListResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList value) {
                ...
                public static class ItemInfoList {
                    ...
                    protected List<OrderListResponse.ResponseBody.OrderInfoList.OrderInfo.ItemInfoList.ItemInfo> itemInfo;
                     ...
                     * 
                     */
                    public List<OrderListResponse.ResponseBody.OrderInfoList.OrderInfo.ItemInfoList.ItemInfo> getItemInfo() {
                        if (itemInfo == null) {
                            itemInfo = new ArrayList<OrderListResponse.ResponseBody.OrderInfoList.OrderInfo.ItemInfoList.ItemInfo>();
                        }
                ...
                public static class PackageInfoList {
                    ...
                    protected List<OrderListResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList.PackageInfo> packageInfo;
                     ...
                     * 
                     */
                    public List<OrderListResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList.PackageInfo> getPackageInfo() {
                        if (packageInfo == null) {
                            packageInfo = new ArrayList<OrderListResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList.PackageInfo>();
                        }
                    ...
                    public static class PackageInfo {
                        ...
                        @XmlElement(name = "ItemInfoList", required = true)
                        @JsonProperty("ItemInfoList")
                        protected OrderListResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList.PackageInfo.ItemInfoList itemInfoList;
                         ...
                         *     
                         */
                        public OrderListResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList.PackageInfo.ItemInfoList getItemInfoList() {
                            return itemInfoList;
                        }
                         ...
                         *     
                         */
                        public void setItemInfoList(OrderListResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList.PackageInfo.ItemInfoList value) {
                            this.itemInfoList = value;
                        }
                        ...
                        public static class ItemInfoList {
                            ...
                            @XmlElement(name = "ItemInfo", required = true)
                            @JsonProperty("ItemInfo")
                            protected List<OrderListResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList.PackageInfo.ItemInfoList.ItemInfo> itemInfo;
                             ...
                             * 
                             */
                            public List<OrderListResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList.PackageInfo.ItemInfoList.ItemInfo> getItemInfo() {
                                if (itemInfo == null) {
                                    itemInfo = new ArrayList<OrderListResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList.PackageInfo.ItemInfoList.ItemInfo>();
                                }
                                return this.itemInfo;
                            }
