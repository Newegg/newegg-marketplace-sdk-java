...
public class RMAListResponse {
    ...
    protected RMAListResponse.ResponseBody responseBody;
     ...
     *     
     */
    public RMAListResponse.ResponseBody getResponseBody() {
        return responseBody;
    }
     ...
     *     
     */
    public void setResponseBody(RMAListResponse.ResponseBody value) {
    ...
    public static class ResponseBody {
        ...
        protected RMAListResponse.ResponseBody.PageInfo pageInfo;
        ...
        @JsonUnwrapped
        protected RMAListResponse.ResponseBody.RMAInfoList rmaInfoList;
         ...
         *     
         */
        public RMAListResponse.ResponseBody.PageInfo getPageInfo() {
            return pageInfo;
        }
         ...
         *     
         */
        public void setPageInfo(RMAListResponse.ResponseBody.PageInfo value) {
            this.pageInfo = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link NeweggAPIResponse.ResponseBody.RmaInfoList }
         *     
         */
        public RMAListResponse.ResponseBody.RMAInfoList getRMAInfoList() {
            return rmaInfoList;
        }
         ...
         *     
         */
        public void setRMAInfoList(RMAListResponse.ResponseBody.RMAInfoList value) {
        ...
        public static class RMAInfoList {
            ...
            protected List<RMAListResponse.ResponseBody.RMAInfoList.RMAInfo> rmaInfo;
             ...
             * 
             */
            public List<RMAListResponse.ResponseBody.RMAInfoList.RMAInfo> getRMAInfo() {
                if (rmaInfo == null) {
                    rmaInfo = new ArrayList<RMAListResponse.ResponseBody.RMAInfoList.RMAInfo>();
                }
                return this.rmaInfo;
            }
            ...
            public static class RMAInfo {
                ...
                protected RMAListResponse.ResponseBody.RMAInfoList.RMAInfo.ItemInfoList itemInfoList;
                @XmlElement(name = "PackageInfoList", required = true)
                @JsonProperty("PackageInfoList")
                protected RMAListResponse.ResponseBody.RMAInfoList.RMAInfo.PackageInfoList packageInfoList;
                 ...
                 *     
                 */
                public RMAListResponse.ResponseBody.RMAInfoList.RMAInfo.ItemInfoList getItemInfoList() {
                    return itemInfoList;
                }
                 ...
                 *     
                 */
                public void setItemInfoList(RMAListResponse.ResponseBody.RMAInfoList.RMAInfo.ItemInfoList value) {
                 ...
                 *     
                 */
                public RMAListResponse.ResponseBody.RMAInfoList.RMAInfo.PackageInfoList getPackageInfoList() {
                 ...
                 *     
                 */
                public void setPackageInfoList(RMAListResponse.ResponseBody.RMAInfoList.RMAInfo.PackageInfoList value) {
                ...
                public static class ItemInfoList {
                    ...
                    protected List<RMAListResponse.ResponseBody.RMAInfoList.RMAInfo.ItemInfoList.ItemInfo> itemInfo;
                     ...
                     * 
                     */
                    public List<RMAListResponse.ResponseBody.RMAInfoList.RMAInfo.ItemInfoList.ItemInfo> getItemInfo() {
                        if (itemInfo == null) {
                            itemInfo = new ArrayList<RMAListResponse.ResponseBody.RMAInfoList.RMAInfo.ItemInfoList.ItemInfo>();
                        }
                ...
                public static class PackageInfoList {
                    ...
                    protected List<RMAListResponse.ResponseBody.RMAInfoList.RMAInfo.PackageInfoList.PackageInfo> packageInfo;
                     ...
                     * 
                     */
                    public List<RMAListResponse.ResponseBody.RMAInfoList.RMAInfo.PackageInfoList.PackageInfo> getPackageInfo() {
                        if (packageInfo == null) {
                            packageInfo = new ArrayList<RMAListResponse.ResponseBody.RMAInfoList.RMAInfo.PackageInfoList.PackageInfo>();
                        }
                    ...
                    public static class PackageInfo {
                        ...
                        @XmlElement(name = "ItemInfoList", required = true)
                        @JsonProperty("ItemInfoList")
                        protected RMAListResponse.ResponseBody.RMAInfoList.RMAInfo.PackageInfoList.PackageInfo.ItemInfoList itemInfoList;
                         ...
                         *     
                         */
                        public RMAListResponse.ResponseBody.RMAInfoList.RMAInfo.PackageInfoList.PackageInfo.ItemInfoList getItemInfoList() {
                            return itemInfoList;
                        }
                         ...
                         *     
                         */
                        public void setItemInfoList(RMAListResponse.ResponseBody.RMAInfoList.RMAInfo.PackageInfoList.PackageInfo.ItemInfoList value) {
                            this.itemInfoList = value;
                        }
                        ...
                        public static class ItemInfoList {
                            ...
                            @XmlElement(name = "ItemInfo", required = true)
                            @JsonProperty("ItemInfo")
                            protected List<RMAListResponse.ResponseBody.RMAInfoList.RMAInfo.PackageInfoList.PackageInfo.ItemInfoList.ItemInfo> itemInfo;
                             ...
                             * 
                             */
                            public List<RMAListResponse.ResponseBody.RMAInfoList.RMAInfo.PackageInfoList.PackageInfo.ItemInfoList.ItemInfo> getItemInfo() {
                                if (itemInfo == null) {
                                    itemInfo = new ArrayList<RMAListResponse.ResponseBody.RMAInfoList.RMAInfo.PackageInfoList.PackageInfo.ItemInfoList.ItemInfo>();
                                }
                                return this.itemInfo;
                            }
