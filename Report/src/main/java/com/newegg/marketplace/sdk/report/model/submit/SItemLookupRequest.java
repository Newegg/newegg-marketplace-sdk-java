...
public class SItemLookupRequest {
    ...
    protected SItemLookupRequest.RequestBody requestBody;
     ...
     *     
     */
    public SItemLookupRequest.RequestBody getRequestBody() {
        return requestBody;
    }
     ...
     *     
     */
    public void setRequestBody(SItemLookupRequest.RequestBody value) {
    ...
    public static class RequestBody {
        ...
        protected SItemLookupRequest.RequestBody.RequestCriteria requestCriteria;
         ...
         *     
         */
        public SItemLookupRequest.RequestBody.RequestCriteria getRequestCriteria() {
         ...
         *     
         */
        public void setRequestCriteria(SItemLookupRequest.RequestBody.RequestCriteria value) {
        ...
        public static class RequestCriteria {
            ...
            @JsonProperty("Item")
            protected List<SItemLookupRequest.RequestBody.RequestCriteria.Item> item;
             ...
             * 
             */
            public List<SItemLookupRequest.RequestBody.RequestCriteria.Item> getItem() {
                if (item == null) {
                    item = new ArrayList<SItemLookupRequest.RequestBody.RequestCriteria.Item>();
                }
                return this.item;
            }
