...
// 產生時間: 2019.03.06 於 09:30:51 AM CST 
//
...
public class SettlementSummaryReportResponse {

    @XmlElement(name = "IsSuccess", required = true)
    @JsonProperty("IsSuccess")
    protected String isSuccess;
    @XmlElement(name = "OperationType", defaultValue = "SettlementSummaryReportResponse", required = true)
    @JsonProperty("OperationType")
    protected String operationType = "SettlementSummaryReportResponse";
    @XmlElement(name = "SellerID", required = true)
    @JsonProperty("SellerID")
    protected String sellerID;
    @XmlElement(name = "ResponseBody", required = true)
    @JsonProperty("ResponseBody")
    protected SettlementSummaryReportResponse.ResponseBody responseBody;
     ...
     * @return
     *     possible object is
     *     {@link SettlementSummaryReportResponse.ResponseBody }
     *     
     */
    public SettlementSummaryReportResponse.ResponseBody getResponseBody() {
        return responseBody;
    }
     ...
     *     
     */
    public void setResponseBody(SettlementSummaryReportResponse.ResponseBody value) {
    ...
    public static class ResponseBody {
        ...
        @JsonUnwrapped
        protected SettlementSummaryReportResponse.ResponseBody.ResponseList responseList;
         ...
         * @return
         *     possible object is
         *     {@link SettlementSummaryReportResponse.ResponseBody.ResponseList }
         *     
         */
        public SettlementSummaryReportResponse.ResponseBody.ResponseList getResponseList() {
            return responseList;
        }
         ...
         *     
         */
        public void setResponseList(SettlementSummaryReportResponse.ResponseBody.ResponseList value) {
        ...
        public static class ResponseList {
            ...
            protected List<SettlementSummaryReportResponse.ResponseBody.ResponseList.ResponseInfo> responseInfo;
             ...
             * {@link SettlementSummaryReportResponse.ResponseBody.ResponseList.ResponseInfo }
             * 
             * @return
             * Objects of the following type(s) are allowed in the list
             * {@link SettlementSummaryReportResponse.ResponseBody.ResponseList.ResponseInfo }
             * 
             */
            public List<SettlementSummaryReportResponse.ResponseBody.ResponseList.ResponseInfo> getResponseInfo() {
                if (responseInfo == null) {
                    responseInfo = new ArrayList<SettlementSummaryReportResponse.ResponseBody.ResponseList.ResponseInfo>();
                }
