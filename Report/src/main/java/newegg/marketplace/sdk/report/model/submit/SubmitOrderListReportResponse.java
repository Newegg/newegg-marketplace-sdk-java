...
// 產生時間: 2019.03.05 於 05:11:37 PM CST 
//
...
public class SubmitOrderListReportResponse {

    @XmlElement(name = "IsSuccess", required = true)
    @JsonProperty("IsSuccess")
    protected String isSuccess;
    @XmlElement(name = "OperationType", defaultValue = "OrderListReportResponse", required = true)
    @JsonProperty("OperationType")
    protected String operationType = "OrderListReportResponse";
    @XmlElement(name = "SellerID", required = true)
    @JsonProperty("SellerID")
    protected String sellerID;
    @XmlElement(name = "ResponseBody", required = true)
    @JsonProperty("ResponseBody")
    protected SubmitOrderListReportResponse.ResponseBody responseBody;
     ...
     * @return
     *     possible object is
     *     {@link SubmitOrderListReportResponse.ResponseBody }
     *     
     */
    public SubmitOrderListReportResponse.ResponseBody getResponseBody() {
        return responseBody;
    }
     ...
     *     
     */
    public void setResponseBody(SubmitOrderListReportResponse.ResponseBody value) {
    ...
    public static class ResponseBody {
        ...
        @JsonUnwrapped
        protected SubmitOrderListReportResponse.ResponseBody.ResponseList responseList;
         ...
         * @return
         *     possible object is
         *     {@link SubmitOrderListReportResponse.ResponseBody.ResponseList }
         *     
         */
        public SubmitOrderListReportResponse.ResponseBody.ResponseList getResponseList() {
            return responseList;
        }
         ...
         *     
         */
        public void setResponseList(SubmitOrderListReportResponse.ResponseBody.ResponseList value) {
        ...
        public static class ResponseList {
            ...
            protected List<SubmitOrderListReportResponse.ResponseBody.ResponseList.ResponseInfo> responseInfo;
             ...
             * {@link SubmitOrderListReportResponse.ResponseBody.ResponseList.ResponseInfo }
             * 
             * @return
             * Objects of the following type(s) are allowed in the list
             * {@link SubmitOrderListReportResponse.ResponseBody.ResponseList.ResponseInfo }
             * 
             */
            public List<SubmitOrderListReportResponse.ResponseBody.ResponseList.ResponseInfo> getResponseInfo() {
                if (responseInfo == null) {
                    responseInfo = new ArrayList<SubmitOrderListReportResponse.ResponseBody.ResponseList.ResponseInfo>();
                }
