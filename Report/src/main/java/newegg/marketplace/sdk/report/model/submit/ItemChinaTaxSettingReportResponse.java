...
// 產生時間: 2019.03.06 於 03:00:25 PM CST 
//
...
public class ItemChinaTaxSettingReportResponse {

    @XmlElement(name = "IsSuccess", required = true)
    @JsonProperty("IsSuccess")
    protected String isSuccess;
    @XmlElement(name = "OperationType", defaultValue = "ItemChinaTaxSettingReportResponse", required = true)
    @JsonProperty("OperationType")
    protected String operationType = "ItemChinaTaxSettingReportResponse";
    @XmlElement(name = "SellerID", required = true)
    @JsonProperty("SellerID")
    protected String sellerID;
    @XmlElement(name = "ResponseBody", required = true)
    @JsonProperty("ResponseBody")
    protected ItemChinaTaxSettingReportResponse.ResponseBody responseBody;
     ...
     * @return
     *     possible object is
     *     {@link ItemChinaTaxSettingReportResponse.ResponseBody }
     *     
     */
    public ItemChinaTaxSettingReportResponse.ResponseBody getResponseBody() {
        return responseBody;
    }
     ...
     *     
     */
    public void setResponseBody(ItemChinaTaxSettingReportResponse.ResponseBody value) {
    ...
    public static class ResponseBody {
        ...
        @JsonUnwrapped
        protected ItemChinaTaxSettingReportResponse.ResponseBody.ResponseList responseList;
         ...
         * @return
         *     possible object is
         *     {@link ItemChinaTaxSettingReportResponse.ResponseBody.ResponseList }
         *     
         */
        public ItemChinaTaxSettingReportResponse.ResponseBody.ResponseList getResponseList() {
            return responseList;
        }
         ...
         *     
         */
        public void setResponseList(ItemChinaTaxSettingReportResponse.ResponseBody.ResponseList value) {
        ...
        public static class ResponseList {
            ...
            protected List<ItemChinaTaxSettingReportResponse.ResponseBody.ResponseList.ResponseInfo> responseInfo;
             ...
             * {@link ItemChinaTaxSettingReportResponse.ResponseBody.ResponseList.ResponseInfo }
             * 
             * @return
             * Objects of the following type(s) are allowed in the list
             * {@link ItemChinaTaxSettingReportResponse.ResponseBody.ResponseList.ResponseInfo }
             * 
             */
            public List<ItemChinaTaxSettingReportResponse.ResponseBody.ResponseList.ResponseInfo> getResponseInfo() {
                if (responseInfo == null) {
                    responseInfo = new ArrayList<ItemChinaTaxSettingReportResponse.ResponseBody.ResponseList.ResponseInfo>();
                }
