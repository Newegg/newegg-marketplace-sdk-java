...
// 產生時間: 2019.03.06 於 02:19:05 PM CST 
//
...
public class PremierItemReportResponse {

    @XmlElement(name = "IsSuccess", required = true)
    @JsonProperty("IsSuccess")
    protected String isSuccess;
    @XmlElement(name = "OperationType", defaultValue = "PremierItemReportResponse", required = true)
    @JsonProperty("OperationType")
    protected String operationType = "PremierItemReportResponse";
    @XmlElement(name = "SellerID", required = true)
    @JsonProperty("SellerID")
    protected String sellerID;
    @XmlElement(name = "ResponseBody", required = true)
    @JsonProperty("ResponseBody")
    protected PremierItemReportResponse.ResponseBody responseBody;
     ...
     * @return
     *     possible object is
     *     {@link PremierItemReportResponse.ResponseBody }
     *     
     */
    public PremierItemReportResponse.ResponseBody getResponseBody() {
        return responseBody;
    }
     ...
     *     
     */
    public void setResponseBody(PremierItemReportResponse.ResponseBody value) {
    ...
    public static class ResponseBody {
        ...
        @JsonUnwrapped
        protected PremierItemReportResponse.ResponseBody.ResponseList responseList;
         ...
         * @return
         *     possible object is
         *     {@link PremierItemReportResponse.ResponseBody.ResponseList }
         *     
         */
        public PremierItemReportResponse.ResponseBody.ResponseList getResponseList() {
            return responseList;
        }
         ...
         *     
         */
        public void setResponseList(PremierItemReportResponse.ResponseBody.ResponseList value) {
        ...
        public static class ResponseList {
            ...
            protected List<PremierItemReportResponse.ResponseBody.ResponseList.ResponseInfo> responseInfo;
             ...
             * {@link PremierItemReportResponse.ResponseBody.ResponseList.ResponseInfo }
             * 
             * @return
             * Objects of the following type(s) are allowed in the list
             * {@link PremierItemReportResponse.ResponseBody.ResponseList.ResponseInfo }
             * 
             */
            public List<PremierItemReportResponse.ResponseBody.ResponseList.ResponseInfo> getResponseInfo() {
                if (responseInfo == null) {
                    responseInfo = new ArrayList<PremierItemReportResponse.ResponseBody.ResponseList.ResponseInfo>();
                }
