...
public class RMAVoidRequest {
	...
	protected RMAVoidRequest.RequestBody requestBody;
	...
	public RMAVoidRequest.RequestBody getRequestBody() {
		return requestBody;
	}

	public void setRequestBody(RMAVoidRequest.RequestBody requestBody) {
