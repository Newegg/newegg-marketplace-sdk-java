...
public class EditRMARequest {
	...
	protected String operationType = "EditRMARequest";

	@XmlElement(name = "RequestBody", required = true)
	@JsonProperty("RequestBody")
	protected EditRMARequest.RequestBody requestBody;
	...
	public EditRMARequest.RequestBody getRequestBody() {
		return requestBody;
	}

	public void setRequestBody(EditRMARequest.RequestBody requestBody) {
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "editRMAInfo" })
