...
public class ReceiveRMARequest {
	...
	protected String operationType = "ReceiveRMARequest";

	@XmlElement(name = "RequestBody", required = true)
	@JsonProperty("RequestBody")
	protected ReceiveRMARequest.RequestBody requestBody;
	...
	public ReceiveRMARequest.RequestBody getRequestBody() {
		return requestBody;
	}

	public void setRequestBody(ReceiveRMARequest.RequestBody requestBody) {
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "receiveRMAInfo" })
