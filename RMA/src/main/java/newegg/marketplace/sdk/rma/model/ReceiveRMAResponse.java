...
public class ReceiveRMAResponse {
	...
	protected String operationType = "ReceiveRMAResponse";
	...
	protected ReceiveRMAResponse.ResponseBody responseBody;
	...
	public ReceiveRMAResponse.ResponseBody getResponseBody() {
		return responseBody;
	}

	public void setResponseBody(ReceiveRMAResponse.ResponseBody responseBody) {
	...
	public static class ResponseBody {
		...
		protected ReceiveRMAResponse.ResponseBody.RMAInfo rmaInfo;

		public ReceiveRMAResponse.ResponseBody.RMAInfo getRmaInfo() {
			return rmaInfo;
		}

		public void setRmaInfo(ReceiveRMAResponse.ResponseBody.RMAInfo rmaInfo) {
		...
		public static class RMAInfo {
			...
			protected ReceiveRMAResponse.ResponseBody.RMAInfo.RMATransactionList rmaTransactionList;
			...
			public ReceiveRMAResponse.ResponseBody.RMAInfo.RMATransactionList getRmaTransactionList() {
				return rmaTransactionList;
			}

			public void setRmaTransactionList(ReceiveRMAResponse.ResponseBody.RMAInfo.RMATransactionList rmaTransactionList) {
			...
			public static class RMATransactionList {
				...
				protected ReceiveRMAResponse.ResponseBody.RMAInfo.RMATransactionList.RMATransaction rmaTransaction;
				 ...
				 * 
				 * <p>
				 * Objects of the following type(s) are allowed in the list {@link ReceiveRMAResponse.ResponseBody.RMAInfo.RMATransactionList.RMATransaction }
				 * 
				 * @return
				 * possible object is 
				 *     {@link ReceiveRMAResponse.ResponseBody.RMAInfo.RMATransactionList.RMATransaction }
				 * 
				 */
				public ReceiveRMAResponse.ResponseBody.RMAInfo.RMATransactionList.RMATransaction getRmaTransaction() {
