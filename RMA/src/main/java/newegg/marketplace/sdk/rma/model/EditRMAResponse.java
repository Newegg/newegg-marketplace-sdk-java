...
public class EditRMAResponse {
	...
	protected String operationType = "EditRMAResponse";
	...
	protected EditRMAResponse.ResponseBody responseBody;
	...
	public EditRMAResponse.ResponseBody getResponseBody() {
		return responseBody;
	}

	public void setResponseBody(EditRMAResponse.ResponseBody responseBody) {
	...
	public static class ResponseBody {
		...
		protected EditRMAResponse.ResponseBody.RMAInfo rmaInfo;

		public EditRMAResponse.ResponseBody.RMAInfo getRmaInfo() {
			return rmaInfo;
		}

		public void setRmaInfo(EditRMAResponse.ResponseBody.RMAInfo rmaInfo) {
		...
		public static class RMAInfo {
			...
			protected EditRMAResponse.ResponseBody.RMAInfo.RMATransactionList rmaTransactionList;
			...
			public EditRMAResponse.ResponseBody.RMAInfo.RMATransactionList getRmaTransactionList() {
				return rmaTransactionList;
			}

			public void setRmaTransactionList(EditRMAResponse.ResponseBody.RMAInfo.RMATransactionList rmaTransactionList) {
			...
			public static class RMATransactionList {
				...
				protected EditRMAResponse.ResponseBody.RMAInfo.RMATransactionList.RMATransaction rmaTransaction;
				 ...
				 * 
				 * <p>
				 * Objects of the following type(s) are allowed in the list {@link EditRMAResponse.ResponseBody.RMAInfo.RMATransactionList.RMATransaction }
				 * 
				 * @return
				 * possible object is 
				 *     {@link EditRMAResponse.ResponseBody.RMAInfo.RMATransactionList.RMATransaction }
				 * 
				 */
				public EditRMAResponse.ResponseBody.RMAInfo.RMATransactionList.RMATransaction getRmaTransaction() {
