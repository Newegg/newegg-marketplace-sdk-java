...
public class ShipOrderRequestJSON implements ShipOrderRequestImpl {
    ...
    //@JsonProperty("Value")
    private ShipOrderRequestJSON.Value value;
    ...
    @JsonProperty("Value")
    public ShipOrderRequestJSON.Value getValue() {
    	return this.value;
    }
    
    @JsonProperty("Value")
    public void setValue(ShipOrderRequestJSON.Value v) {
    	this.value = v;
    }
    ...
    public static class Value {
	    ...
	    protected ShipOrderRequestJSON.Value.Shipment shipment;
		
	    public void setShipment(ShipOrderRequestJSON.Value.Shipment v) {
	    	this.shipment = v;
	    }
	    
	    public ShipOrderRequestJSON.Value.Shipment getShipment() {
	    ...
	    public static class Shipment {
		    ...
		    @JsonProperty("Header")
		    protected ShipOrderRequestJSON.Value.Shipment.Header header;
		    @XmlElement(name = "PackageList", required = true)
		    @JsonProperty("PackageList")
		    protected ShipOrderRequestJSON.Value.Shipment.PackageList packageList;
		     ...
		     *     
		     */
		    public ShipOrderRequestJSON.Value.Shipment.Header getHeader() {
		        return header;
		    }
		     ...
		     *     
		     */
		    public void setHeader(ShipOrderRequestJSON.Value.Shipment.Header value) {
		        this.header = value;
		    }
		     ...
		     *     
		     */
		    public ShipOrderRequestJSON.Value.Shipment.PackageList getPackageList() {
		        return packageList;
		    }
		     ...
		     *     
		     */
		    public void setPackageList(ShipOrderRequestJSON.Value.Shipment.PackageList value) {
		    ...
		    public static class PackageList {
		        ...
		        protected List<ShipOrderRequestJSON.Value.Shipment.PackageList.Package> _package;
		        ...
		        public List<ShipOrderRequestJSON.Value.Shipment.PackageList.Package> getPackage() {
		            if (_package == null) {
		                _package = new ArrayList<ShipOrderRequestJSON.Value.Shipment.PackageList.Package>();
		            }
		        ...
		        public static class Package {
		            ...
		            protected ShipOrderRequestJSON.Value.Shipment.PackageList.Package.ItemList itemList;
		             ...
		             *     
		             */
		            public ShipOrderRequestJSON.Value.Shipment.PackageList.Package.ItemList getItemList() {
		                return itemList;
		            }
		             ...
		             *     
		             */
		            public void setItemList(ShipOrderRequestJSON.Value.Shipment.PackageList.Package.ItemList value) {
		                this.itemList = value;
		            }
		            ...
		            public static class ItemList {
		                ...
		                @JsonProperty("Item")
		                protected List<ShipOrderRequestJSON.Value.Shipment.PackageList.Package.ItemList.Item> item;
		                ...
		                public List<ShipOrderRequestJSON.Value.Shipment.PackageList.Package.ItemList.Item> getItem() {
		                    if (item == null) {
		                        item = new ArrayList<ShipOrderRequestJSON.Value.Shipment.PackageList.Package.ItemList.Item>();
		                    }
		                    return this.item;
		                }
