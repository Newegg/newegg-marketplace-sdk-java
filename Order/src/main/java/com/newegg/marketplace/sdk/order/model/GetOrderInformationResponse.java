...
public class GetOrderInformationResponse {
    ...
    protected GetOrderInformationResponse.ResponseBody responseBody;
    ...
    public static class ResponseBody {
        ...
        protected GetOrderInformationResponse.ResponseBody.PageInfo pageInfo;
        ...
        public static class OrderInfoList {
            ...
            protected List<GetOrderInformationResponse.ResponseBody.OrderInfoList.OrderInfo> orderInfo;
            ...
            public List<GetOrderInformationResponse.ResponseBody.OrderInfoList.OrderInfo> getOrderInfo() {
                if (orderInfo == null) {
                    orderInfo = new ArrayList<GetOrderInformationResponse.ResponseBody.OrderInfoList.OrderInfo>();
                }
            ...
            public static class OrderInfo {
                ...
                protected GetOrderInformationResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList packageInfoList;
                ...
                public static class ItemInfoList {
                    ...
                    protected List<GetOrderInformationResponse.ResponseBody.OrderInfoList.OrderInfo.ItemInfoList.ItemInfo> itemInfo;
                    ...
                    public List<GetOrderInformationResponse.ResponseBody.OrderInfoList.OrderInfo.ItemInfoList.ItemInfo> getItemInfo() {
                        if (itemInfo == null) {
                            itemInfo = new ArrayList<GetOrderInformationResponse.ResponseBody.OrderInfoList.OrderInfo.ItemInfoList.ItemInfo>();
                        }
                ...
                public static class PackageInfoList {
                    ...
                    protected List<GetOrderInformationResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList.PackageInfo> packageInfo;
                    ...
                    public List<GetOrderInformationResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList.PackageInfo> getPackageInfo() {
                        if (packageInfo == null) {
                            packageInfo = new ArrayList<GetOrderInformationResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList.PackageInfo>();
                        }
                    ...
                    public static class PackageInfo {
                        ...
                        @XmlElement(name = "ItemInfoList", required = true)
                        @JsonProperty("ItemInfoList")
                        protected GetOrderInformationResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList.PackageInfo.ItemInfoList itemInfoList;
                        ...
                        public static class ItemInfoList {
                            ...
                            @XmlElement(name = "ItemInfo", required = true)
                            @JsonProperty("ItemInfo")
                            protected List<GetOrderInformationResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList.PackageInfo.ItemInfoList.ItemInfo> itemInfo;
                            ...
                            public List<GetOrderInformationResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList.PackageInfo.ItemInfoList.ItemInfo> getItemInfo() {
                                if (itemInfo == null) {
                                    itemInfo = new ArrayList<GetOrderInformationResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList.PackageInfo.ItemInfoList.ItemInfo>();
                                }
                                return this.itemInfo;
                            }
