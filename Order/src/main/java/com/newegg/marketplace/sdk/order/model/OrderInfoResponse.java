...
// 產生時間: 2019.02.22 於 02:29:59 PM CST 
//
...
public class OrderInfoResponse {
    ...
    protected OrderInfoResponse.ResponseBody responseBody;
     ...
     *     
     */
    public OrderInfoResponse.ResponseBody getResponseBody() {
        return responseBody;
    }
     ...
     *     
     */
    public void setResponseBody(OrderInfoResponse.ResponseBody value) {
    ...
    public static class ResponseBody {
        ...
        protected OrderInfoResponse.ResponseBody.PageInfo pageInfo;
        @XmlElement(name = "OrderInfoList", required = true)
        @JsonProperty("OrderInfoList")
        @JsonUnwrapped
        protected OrderInfoResponse.ResponseBody.OrderInfoList orderInfoList;
         ...
         *     
         */
        public OrderInfoResponse.ResponseBody.PageInfo getPageInfo() {
            return pageInfo;
        }
         ...
         *     
         */
        public void setPageInfo(OrderInfoResponse.ResponseBody.PageInfo value) {
            this.pageInfo = value;
        }
         ...
         *     
         */
        public OrderInfoResponse.ResponseBody.OrderInfoList getOrderInfoList() {
         ...
         *     
         */
        public void setOrderInfoList(OrderInfoResponse.ResponseBody.OrderInfoList value) {
        ...
        public static class OrderInfoList {
            ...
            protected List<OrderInfoResponse.ResponseBody.OrderInfoList.OrderInfo> orderInfo;
             ...
             * 
             */
            public List<OrderInfoResponse.ResponseBody.OrderInfoList.OrderInfo> getOrderInfo() {
                if (orderInfo == null) {
                    orderInfo = new ArrayList<OrderInfoResponse.ResponseBody.OrderInfoList.OrderInfo>();
                }
            ...
            public static class OrderInfo {
                ...
                protected OrderInfoResponse.ResponseBody.OrderInfoList.OrderInfo.ItemInfoList itemInfoList;
                @XmlElement(name = "PackageInfoList", required = true)
                @JsonProperty("PackageInfoList")
                protected OrderInfoResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList packageInfoList;
                 ...
                 *     
                 */
                public OrderInfoResponse.ResponseBody.OrderInfoList.OrderInfo.ItemInfoList getItemInfoList() {
                    return itemInfoList;
                }
                 ...
                 *     
                 */
                public void setItemInfoList(OrderInfoResponse.ResponseBody.OrderInfoList.OrderInfo.ItemInfoList value) {
                 ...
                 *     
                 */
                public OrderInfoResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList getPackageInfoList() {
                 ...
                 *     
                 */
                public void setPackageInfoList(OrderInfoResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList value) {
                ...
                public static class ItemInfoList {
                    ...
                    protected List<OrderInfoResponse.ResponseBody.OrderInfoList.OrderInfo.ItemInfoList.ItemInfo> itemInfo;
                     ...
                     * 
                     */
                    public List<OrderInfoResponse.ResponseBody.OrderInfoList.OrderInfo.ItemInfoList.ItemInfo> getItemInfo() {
                        if (itemInfo == null) {
                            itemInfo = new ArrayList<OrderInfoResponse.ResponseBody.OrderInfoList.OrderInfo.ItemInfoList.ItemInfo>();
                        }
                ...
                public static class PackageInfoList {
                    ...
                    protected List<OrderInfoResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList.PackageInfo> packageInfo;
                     ...
                     * 
                     */
                    public List<OrderInfoResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList.PackageInfo> getPackageInfo() {
                        if (packageInfo == null) {
                            packageInfo = new ArrayList<OrderInfoResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList.PackageInfo>();
                        }
                    ...
                    public static class PackageInfo {
                        ...
                        @XmlElement(name = "ItemInfoList", required = true)
                        @JsonProperty("ItemInfoList")
                        protected OrderInfoResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList.PackageInfo.ItemInfoList itemInfoList;
                         ...
                         *     
                         */
                        public OrderInfoResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList.PackageInfo.ItemInfoList getItemInfoList() {
                            return itemInfoList;
                        }
                         ...
                         *     
                         */
                        public void setItemInfoList(OrderInfoResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList.PackageInfo.ItemInfoList value) {
                            this.itemInfoList = value;
                        }
                        ...
                        public static class ItemInfoList {
                            ...
                            @XmlElement(name = "ItemInfo", required = true)
                            @JsonProperty("ItemInfo")
                            protected List<OrderInfoResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList.PackageInfo.ItemInfoList.ItemInfo> itemInfo;
                             ...
                             * 
                             */
                            public List<OrderInfoResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList.PackageInfo.ItemInfoList.ItemInfo> getItemInfo() {
                                if (itemInfo == null) {
                                    itemInfo = new ArrayList<OrderInfoResponse.ResponseBody.OrderInfoList.OrderInfo.PackageInfoList.PackageInfo.ItemInfoList.ItemInfo>();
                                }
                                return this.itemInfo;
                            }
