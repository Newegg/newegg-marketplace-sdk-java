...
public interface ShipmentCaller {
	...
	ShipmentResponse sendShipmentRequestJSON(
	...
	@RequestLine("PUT /ordermgmt/orderstatus/orders/{ordernumber}?sellerid={sellerid}&version={version}")
	ShipmentResponse sendShipmentRequestXML(
			@Param("ordernumber") String orderNumber,
			@Param("sellerid") String sellerID, 
			@Param("version") String version,
			ShipOrderWrapper body);
	...
	default ShipmentResponse sendShipmentRequest(ShipOrderImpl body) {
		switch(Variables.MediaType) {
		case JSON:			
			return sendShipmentRequestJSON(Variables.orderNumber, Content.SellerID, Variables.version, (ShipOrderRequest)body);
			
		case XML:			
			return sendShipmentRequestXML(Variables.orderNumber, Content.SellerID, Variables.version, (ShipOrderWrapper)body);	
