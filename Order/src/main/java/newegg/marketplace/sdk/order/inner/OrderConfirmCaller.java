 ...
 *
 */
public interface OrderConfirmCaller {
	/*
	...
	default OrderConfirmationResponse sendOrderConfirmRequest(OrderConfirmationRequest body) {
		...
		case XML:			
			return sendOrderConfirmRequestXML(Content.SellerID, body);	
	...
	static OrderConfirmCaller buildJSON() {
		Variables.MediaType = MEDIA_TYPE.JSON;
		
		return new CallerFactory<OrderConfirmCaller>()
		.jsonBuild(OrderConfirmCaller.class, Variables.LogLevel, Variables.Retryer, OrderClient.genClient());		
	}

	static OrderConfirmCaller buildXML() {
		Variables.MediaType = MEDIA_TYPE.XML;
		
		return new CallerFactory<OrderConfirmCaller>()
		.xmlBuild(OrderConfirmCaller.class, Variables.LogLevel, Variables.Retryer, OrderClient.genClient());		
	}
