...
public class MultiChannelOrderRequest {

    @XmlElement(name = "Header", required = true)
    protected MultiChannelOrderRequest.Header header=new MultiChannelOrderRequest.Header();
    @XmlElement(name = "MessageType", required = true)
    protected String messageType="MultiChannelOrderCreation";
    @XmlElement(name = "Message", required = true)
    protected MultiChannelOrderRequest.Message message;
     ...
     * @return
     *     possible object is
     *     {@link MultiChannelOrderRequest.Header }
     *     
     */
    public MultiChannelOrderRequest.Header getHeader() {
        return header;
    }
     ...
     *     
     */
    public void setHeader(MultiChannelOrderRequest.Header value) {
        this.header = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link MultiChannelOrderRequest.Message }
     *     
     */
    public MultiChannelOrderRequest.Message getMessage() {
        return message;
    }
     ...
     *     
     */
    public void setMessage(MultiChannelOrderRequest.Message value) {
        this.message = value;
    }
    ...
    public static class Message {
        ...
        protected MultiChannelOrderRequest.Message.MultiChannelOrder multiChannelOrder;

        public MultiChannelOrderRequest.Message.MultiChannelOrder getMultiChannelOrder() {
			return multiChannelOrder;
		}

		public void setMultiChannelOrder(MultiChannelOrderRequest.Message.MultiChannelOrder multiChannelOrder) {
        ...
        public static class MultiChannelOrder {
            ...
            protected List<MultiChannelOrderRequest.Message.MultiChannelOrder.Order> order;

 
            public List<MultiChannelOrderRequest.Message.MultiChannelOrder.Order> getOrder() {
                if (order == null) {
                    order = new ArrayList<MultiChannelOrderRequest.Message.MultiChannelOrder.Order>();
                }
                return this.order;
            }
            ...
            public static class Order {
                ...
                public static class ItemList{
                	...
                	protected List<MultiChannelOrderRequest.Message.MultiChannelOrder.Order.ItemList.Item> item;
                	
                	 public List<MultiChannelOrderRequest.Message.MultiChannelOrder.Order.ItemList.Item> getItem() {
                		 if(item==null) {
                			 item=new ArrayList<MultiChannelOrderRequest.Message.MultiChannelOrder.Order.ItemList.Item>();
                		 }
						return this.item;
					}
