...
import com.newegg.marketplace.sdk.datafeed.model.VolumeDiscount.Message.VolumeDiscountList;
import com.newegg.marketplace.sdk.datafeed.model.VolumeDiscount.Message.VolumeDiscountList.ItemVolumeDiscountInfo;
import com.newegg.marketplace.sdk.datafeed.model.VolumeDiscount.Message.VolumeDiscountList.ItemVolumeDiscountInfo.DiscountSetting;
import com.newegg.marketplace.sdk.datafeed.model.VolumeDiscount.Message.VolumeDiscountList.ItemVolumeDiscountInfo.DiscountSetting.Tier;
...
public class SubmitActivityCallerTest {
	...
	public void testMockVolumeDiscountFeed_XML() {
		...
		VolumeDiscount request=new VolumeDiscount();
		VolumeDiscount.Message m=new VolumeDiscount.Message();
		...
		SubmitFeedResponse r=call.volumeDiscountFeed(request);
	...
	public void testMockItemPromotionFeed_XML() {
		...
		Variables.SimulationEnabled=true;
		SubmitActivityCaller call=SubmitActivityCaller.buildXML();
		ItemPromotion request=new ItemPromotion();
		ItemPromotion.Message m=new ItemPromotion.Message();
		ItemPromotion.Message.Item i1=new ItemPromotion.Message.Item();
		...
		ItemPromotion.Message.Item i2=new ItemPromotion.Message.Item();
		...
		m.getItem().add(i2);
		request.setMessage(m);
		SubmitFeedResponse r=call.itemPromotionFeed(request);
		Variables.SimulationEnabled=false;
		assertTrue(r.getIsSuccess());		
		assertEquals("2291326430",r.getResponseBody().getResponseList().getResponseInfo().get(0).getRequestId());
	...
	public void testMockItemPremierMarkFeed_XML() {
		Variables.SimulationEnabled=true;
		SubmitActivityCaller call=SubmitActivityCaller.buildXML();
		PremierItemMark request=new PremierItemMark();
		PremierItemMark.Message m=new PremierItemMark.Message();
		PremierItemMark.Message.Item i1=new PremierItemMark.Message.Item();
		i1.setPremierMark("FALSE");
		i1.setSellerPartNumber("JACKETEST0921001004");
		m.getItem().add(i1);
		PremierItemMark.Message.Item i2=new PremierItemMark.Message.Item();
		i2.setPremierMark("TRUE");
		i2.setSellerPartNumber("JACKETEST0921001003");
		m.getItem().add(i2);
		request.setMessage(m);
		SubmitFeedResponse r=call.itemPremierMarkFeed(request);
		Variables.SimulationEnabled=false;
		assertTrue(r.getIsSuccess());		
		assertEquals("2291326430",r.getResponseBody().getResponseList().getResponseInfo().get(0).getRequestId());
